...
public class SoundMgr {
	...
	public void playSound(Player p, JSound sound, float volume, float pitch) {
		
		if(Main.ins.version.contains("1_8")) {
			p.playSound(p.getLocation(), Sound.valueOf(sound.getOld()), volume, pitch);
		} else {
			p.playSound(p.getLocation(), Sound.valueOf(sound.getNew()), volume, pitch);
		}
	...
	public enum JSound {
		...
		CAVE("AMBIENCE_CAVE","AMBIENT_CAVE"),
		RAIN("AMBIENCE_RAIN", "WEATHER_RAIN"),
		THUNDER("AMBIENCE_THUNDER", "ENTITY_LIGHTNING_THUNDER"),
		ANVIL_BREAK("ANVIL_BREAK","BLOCK_ANVIL_BREAK"),
		ANVIL_DESTROY("","ANVIL_DESTROY"),
		ANVIL_FALL("", "BLOCK_ANVIL_FALL"),
		ANVIL_HIT("", "BLOCK_ANVIL_HIT"),
		ANVIL_PLACE("", "BLOCK_ANVIL_PLACE"),
		ANVIL_LAND("ANVIL_LAND","BLOCK_ANVIL_LAND"),
		ANVIL_USE("ANVIL_USE", "BLOCK_ANVIL_USE"),
		ANVIL_STEP("", "BLOCK_ANVIL_STEP"),
		...
		BREWING_STAND_BREW("", "BLOCK_BREWING_STAND_BREW"),
		CAT_HISS("CAT_HISS","ENTITY_CAT_AMBIENT"),
		CAT_HIT("CAT_HIT","ENTITY_CAT_HISS"),
		...
		CHORUS_FLOWER_DEATH("", "BLOCK_CHORUS_FLOWER_DEATH"),
		CHORUS_FLOWER_GROW("", "BLOCK_CHORUS_FLOWER_GROW"),
		CHEST_LOCKED("", "BLOCK_CHEST_LOCKED"),
		...
		COMPARATOR_CLICK("", "BLOCK_COMPARATOR_CLICK"),
		DISPENSER_DISPENSE("", "BLOCK_DISPENSER_DISPENSE"),
		DISPENSER_FAIL("", "BLOCK_DISPENSER_FAIL"),
		DISPENSER_LAUNCH("", "BLOCK_DISPENSER_LAUNCH"),
		...
		DONKEY_CLOSE("DONKEY_CLOSE", ""),
		DONKEY_OPEN("DONKEY_OPEN", ""),
		...
		ENDERDMAN_DEATH("ENDERMAN_DEATH", "ENTITY_ENDERMEN_DEATH"),
		...
		END_GATEWAY_SPAWN("", "BLOCK_END_GATEWAY_SPAWN"),
		ENDERCHEST_CLOSE("", "BLOCK_ENDERCHEST_CLOSE"),
		ENDERCHEST_OPEN("", "BLOCK_ENDERCHEST_OPEN"),
		...
		FENCE_GATE_CLOSE("", "BLOCK_FENCE_GATE_CLOSE"),
		FENCE_GATE_OPEN("", "BLOCK_FENCE_GATE_OPEN"),
		FIRE_EXTINGUISH("", "BLOCK_FIRE_EXTINGUISH"),
		BLOCK_FURNACE_FIRE_CRACKLE("", "BLOCK_FURNACE_FIRE_CRACKLE"),
		FIZZ("FIZZ", ""),
		FUSE("FUSE", ""),
		GHAST_CHARGE("GHAST_CHARGE", "ENTITY_GHAST_SHOOT"),
		GHAST_DEATH("GHAST_DEATH", "ENTITY_GHAST_DEATH"),
		GHAST_FIREBALL("GHAST_FIREBALL", "ENTITY_GHAST_SHOOT"),
		GHAST_MOAN("GHAST_MOAN", "ENTITY_GHAST_HURT"),
		...
		LAVA_EXTINGUISH("", "BLOCK_LAVA_EXTINGUISH"),
		...
		NOTE_STICKS("NOTE_SNARE_DRUM", "BLOCK_NOTE_SNARE"),
		NOTE_HARP("", "BLOCK_NOTE_HARP"),
		NOTE_HAT("", "BLOCK_NOTE_HAT"),
		...
		SLIME_WALK2("SLIME_WALK2", "ENTITY_SLIME_JUMP"),
		...
		SPLASH2("SPLASH2", "ENTITY_GENERIC_SWIM"),
		...
		STEP_WOOL("STEP_WOOL", ""),
		SUCCESSFUL_HIT("SUCCESSFUL_HIT", "ENTITY_ARROW_HIT"),
		...
		WITHER_DEATH("WITHER_DEATH", "ENTITY_WITCH_DEATH"),
		...
		WOOD_CLICK("WOOD_CLICK", "UI_BUTTON_CLICK"),
		...
		IRON_DOOR_CLOSE("", "BLOCK_IRON_DOOR_CLOSE"),
		IRON_DOOR_OPEN("", "BLOCK_IRON_DOOR_OPEN"),
		IRON_TRAPDOOR_CLOSE("", "BLOCK_IRON_TRAPDOOR_CLOSE"),
		IRON_TRAPDOOR_OPEN("", "BLOCK_IRON_TRAPDOOR_OPEN"),
		...
		JSound(String oldS, String newS) {
			this.oldS = oldS;
			this.newS = newS;
		}
